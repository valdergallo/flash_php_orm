...
*
* 	INCLUS? DA FUN?O ENCODECONFIG
*
* 	INCLUS? DA FUN?O MOEDA
*
* 	INCLUS? DA FUN?O DATA
*
* 	CORRE?ES no where dos fetch, assoc, insert, update - faltava um espa? entre os caracteres
*
* 	CORRE?O NA TRANSFORMA?ES DE DATA PARA BR
* 	cria?o de TABELAS
*
* 	INCLUS? DA FUN?O CREATETABLE PARA CRIAR TABELAS
*
